      ...
      "<div class=\"base-panel\">"
        "<form action=\"" AUTOCONNECT_URI_CONNECT "\" method=\"post\">"
          ...
          "<ul class=\"noorder\">"
            ...
            "</li>"
            "<li>"
              "<label for=\"email\">" AUTOCONNECT_PAGECONFIG_EMAIL "</label>"
              "<input id=\"email\" type=\"text\" name=\"" AUTOCONNECT_PARAMID_EMAIL "\" placeholder=\"" "Your Email" "\">"
            "</li>"
            "<li>"
              "<label for=\"timezone\">" "Select TZ name" "</label>"
